...
Le package permet d'importer, par de simples lignes de commande, les fichiers diffusés par le projet de recherche Subwork. Les fichiers et la documentation associée sont déposés sur Nakala : https://nakala.fr/10.34847/nkl.c8caljc9.
...
A noter : l'import de certains fichiers (comme par exemple *SH81*) peut prendre plusieurs secondes voire une ou deux minutes...
